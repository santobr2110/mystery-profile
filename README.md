...
Edite `cards.json`. Cada carta tem `category` (Person, Place, Thing, Food ou Animal), `level` (A1, A2, B1 ou B2), `answer`, `aliases` (outras respostas aceitas) e exatamente **10** `clues`. Categorias e níveis novos aparecem sozinhos no lobby. Reinicie o servidor depois de editar.

Total atual: **780 cartas** — 150 no A1, 180 no A2, 200 no B1 e 250 no B2.
...
| `cards.json` | As 780 cartas de vocabulário nos níveis A1, A2, B1 e B2 |
